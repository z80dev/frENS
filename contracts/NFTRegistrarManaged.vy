...
interface IResolver:
    def addr(nodehash: bytes32) -> address: view
    def text(nodehash: bytes32, k: String[100]) -> String[100]: view
    def setAddr(nodehash: bytes32, addr: address): nonpayable
    def setText(nodehash: bytes32, k: String[100], v: String[100]): nonpayable
